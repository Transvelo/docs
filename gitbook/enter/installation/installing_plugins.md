...
The following is the list of plugins in alphabetical order that are recommended for use with **Enter** Wordpress theme.
...
1. After you have activated your theme, you'll see a notice about required plugins for **Enter**, to proceed click **"Begin installing plugins"**.
