...
After you've successfully uploaded and activated **Unicase** theme, it is time to setup the theme.
...
2. Configuring the menus that go in the **Top Bar**.
3. Configuring the menus that go in the **main-navigation**.
...
Here is the **video** for setting the WooCommerce Pages

<iframe width="560" height="315" src="https://www.youtube.com/embed/2VOctKn-1tE" frameborder="0" allowfullscreen></iframe>
...
While adding products, **Unicase** theme allows you to add additional information to the products, that additional information is [**Product Attributes**](product_attributes.md). Read about managing Product Attributes by [**clicking here**](product_attributes.md).
