...
![](http://transvelo.github.io/docs/pizzaro/images/kc-backend-editor-button.png)
...
4. Use **Pizzaro Page Attributes** metabox if required.
...
![](http://transvelo.github.io/docs/pizzaro/images/kc-backend-editor.png)
...
It has **40+ predefined elements** that you can add to your pages. Pizzaro Theme has many additional Pizzaro Elements to the King Composer and has also extended the functionality of existing King Composer Elements.

### Page Templates

Pizzaro has 10 Page templates and they are :
...
3. **Contactpage Template** - This template is used to display the **Contact** page.
...
### Pizzaro Page Options Meta Box

![](http://transvelo.github.io/docs/pizzaro/images/page-attributes.png)

The **Pizzaro Page Options Meta Box** is available for all Pages. It helps you to override certain default settings of the Page Template. The following are its settings :
...
| Additional Body Classes | Text | Add Custom Classes for page. |
