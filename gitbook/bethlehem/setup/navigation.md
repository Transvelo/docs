...
6. After you have saved the menu, hook the menu to the available **Bethlehem** Nav menu location.
...
## Menu Location in Bethlehem

**Bethlehem** has navigation menu location as:
