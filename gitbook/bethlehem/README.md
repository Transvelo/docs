...
**Bethlehem** is a Wordpress theme designed and developed for use with Wordpress 4.2.2 or higher. The code was written to be backwards compatible where possible, however we recommend you use the current WP version when possible. If you are not using WordPress 4.2.2 or higher and can upgrade your site we recommend you do this before installation.
