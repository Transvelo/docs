...
6. After you have saved the menu, hook the menu to the  available **Primary Menu** Nav menu location.
...
**Playhouse** has two navigation menu locations. They are :

1. Primary Menu
2. Get to know as Menu

### Navigation Menu and their location in Header

![](http://transvelo.github.io/docs/playhouse/images/navigation-menu.png)
