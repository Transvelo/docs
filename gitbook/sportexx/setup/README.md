...
After you've successfully uploaded and activated **Sportexx** theme, it is time to setup the theme.
...
2. Configuring the information in the **header**.
3. Configuring the menus that go in the **Top Bar**.
4. Configuring the menus that go in the **main-navigation**.
...
While adding products, **Sportexx** theme allows you to add additional information to the products, that additional information is [**Product Attributes**](product_attributes.md). Read about managing Product Attributes by [**clicking here**](product_attributes.md).
