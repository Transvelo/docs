...
![](http://transvelo.github.io/sportexx/docs/images/edit-test-megamenu-item.png)
...
* We will select a predefined grid which is 1/4 + 1/4 + 1/4 + 1/4. <br/>![](http://transvelo.github.io/sportexx/docs/images/vc-four-column-grid.png)

* Once you click on the predefined grid layout it will look like this :<br/>![](http://transvelo.github.io/sportexx/docs/images/vc-four-col-grid-on-selection.png)
...
![](http://transvelo.github.io/sportexx/docs/images/vc-megamenu-backend-editor.png)

Click on **Publish** button and view the output.

### 4. The Output

![](http://transvelo.github.io/sportexx/docs/images/vc-megamenu-advanced.png)
...
![](http://transvelo.github.io/sportexx/docs/images/yamm-fw.png)

### 6. Megamenu Full-width

![](http://transvelo.github.io/sportexx/docs/images/yamm-fw-output.png)
